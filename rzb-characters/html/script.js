...
function setupCharacters(characters) {
    $.each(characters, function(index, char){
        ...
        setTimeout(function(){
            $('#char-'+char.cid).html('<span id="p-name"><span id="info-label"></span>'+char.charinfo.firstname+' '+char.charinfo.lastname+'</span>');
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $("#play-text").html('<i class="fa-solid fa-arrow-right"></i>');
            $("#delete-text").html('<i class="fa-solid fa-trash-can"></i>');
            $("#play").css({"display":"block"});
...
function setCharactersList() {
    ...
    for (let i = 1; i <= NChar; i++) {
        htmlResult += '<div class="character" id="char-'+ i +'" data-cid=""><div class="user"><i class="fa-solid fa-plus"></i></div><span id="slot-name"><span id="cid"></span></span></div>'
    }
    htmlResult += '</div>'
    htmlResult += '<div class="character-btn" id="play"><p id="play-text">Select a character</p></div><div class="character-btn2" id="delete"><p id="delete-text">Select a character</p></div>'
